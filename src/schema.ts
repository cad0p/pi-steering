...
export interface BuiltInWhenLeavesOuter<Writes extends string = string> {
   ...
   * The engine extracts the subcommand run structurally via the
   * walker's `locateSubcommandRun` (no regex, no index math in
   * rules) and matches it against the declared pattern(s).
   *
